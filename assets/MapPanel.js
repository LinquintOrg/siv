    ...
    render() {
        return (
            <View style={styles.container}>
                <Image style={styles.map} source={require('./favicon.png')} />

                <View style={styles.panelContainer} pointerEvents={'box-none'}>

                    <Animated.View
                        pointerEvents={'box-none'}
                        style={[styles.panelContainer, {backgroundColor: 'black', opacity: this._deltaY.interpolate({
                    ...
                    <Interactable.View
                        ...
                        <View style={styles.panel}>
                            ...
                            <Text style={styles.panelTitle}>Yoo wasup</Text>
                        </View>
